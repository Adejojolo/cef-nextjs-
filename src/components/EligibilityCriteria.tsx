                  ...
                  <div key={idx} className="min-w-[calc(50%-12px)] h-[260px] relative rounded-lg overflow-hidden shadow-xl group">
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                      ...
                      <div className="space-y-3">
                        <div>
                          <span className="text-[10px] font-bold uppercase tracking-widest text-white/50 block mb-0.5">Focus</span>
                          <p className="text-sm text-white/90 leading-tight">{sector.focus}</p>
                        </div>
                        <div>
                          <span className="text-[10px] font-bold uppercase tracking-widest text-white/50 block mb-0.5">Ticket Size</span>
                          <p className="text-sm text-[var(--color-accent-green)] font-medium">{sector.ticket}</p>
                        </div>
                        <div>
                          <span className="text-[10px] font-bold uppercase tracking-widest text-white/50 block mb-0.5">Risk Profile</span>
